...
namespace CRMSolutionComparer
{
    public partial class SolutionPicker : UserControl
    {
        ...
        public Entity selectedSolution;
        ...
        {
            selectedSolution = (Entity)lvSolutions.SelectedItems.Cast<ListViewItem>().First().Tag;            
        }
        private void LvSolutions_ColumnClick(object sender, MouseEventArgs e)
        {
            selectedSolution = (Entity)lvSolutions.SelectedItems.Cast<ListViewItem>().First().Tag;
        }
